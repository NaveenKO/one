...
<head>
    ...
    <title>data science Engineer Portfolio</title>
    <style>
        /* General Styles */
        body {
...
<body>
    <header>
        <h1>saroja - data science Engineer</h1>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm saroja, a data science Engineer passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
    ...
    <footer>
        <p>© 2024 saroja | data science Engineer Portfolio | <a href="#about">Back to Top</a></p>
    </footer>
</body>
</html>
